...
## creating the plot and saving into plot4.png file
png("plot4.png", width = 480, height = 480)
## two by two layout
par(mfrow = c(2,2))
## plot A
with(dataset2, plot(date_time, Global_active_power, type = "l", xlab = NA, ylab = "Global Active Power"))
## plot B
with(dataset2, plot(date_time, Voltage, type = "l", xlab = "datetime"))
## plot C
...
## plot D
with(dataset2, plot(date_time, Global_reactive_power, type = "l", xlab = "datetime"))
